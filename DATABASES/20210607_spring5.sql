...
SET DEFINE OFF;
Insert into XE.TBL_BOARD (BNO,TITLE,WRITER,VIEW_COUNT,REPLY_COUNT,REG_DATE,UPDATE_DATE,BOARD_TYPE) values (1,'공지사항 입력1','admin',0,0,to_timestamp('21/05/31 18:47:17.865000000','RR/MM/DD HH24:MI:SSXFF'),null,'notice');
...
SET DEFINE OFF;
Insert into XE.TBL_REPLY (RNO,REPLY_TEXT,REPLYER,REG_DATE,UPDATE_DATE,BNO) values (1,'댓글입력 테스트','admin',to_date('21/05/31','RR/MM/DD'),null,1);
--------------------------------------------------------
...
is
  l_password varchar2(4000);
  l_salt varchar2(4000) := 'O3BIPW8KAMA9WJ6SB0II7CNGRUX15P';
begin
