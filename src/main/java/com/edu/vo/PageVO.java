...
public class PageVO {
	...
	private void calcPage() {
		...
		this.prev = this.startPage > 1;//startPage가 1페이지 아닐때만 prev활성화=false, 상상 - jsp로 구현하시고, 그떄 결과보겠습니다.
