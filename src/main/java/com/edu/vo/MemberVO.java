...
/**
 * 이클래스는 DB에서 Model클래스로 입출력, model에서 Service클래스로 입출력
...
public class MemberVO {
	...
	private Integer point;//정수형 int를 사용하지 않고, Integer를 사용하는 이유는클래스(참조형)데이터형은  Null을 허용하기 때문에 사용.
	...
	//책에서는 롬복loombok.jar 을 사용해서 아래내용을 생략가능합니다.
