 ...
 * @author 최치원
 * 컨트롤러 기능 @Controller(jsp와 바인딩이 필요할때 )
 * 콤포넌트 @Component는 MVC가 아닌 기능들을 모아놓은 스프링빈 명시, 여기서는 jsp와 바인딩이 필요해서 사용않함
 */
@Controller
public class CommonUtil {
	...
	//RestAPI서버 맛보기 (제대로 만들면 @RestCOntroller 사용)
	...
	public String fileUpload(MultipartFile file) {
		// TODO UUID클래스로 저장됨 고유식별(PK) 파일명을 생성 후 물리적으로 저장
