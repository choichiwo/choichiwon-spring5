          ...
          <form name="form_write" action="/admin/member/member_update" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input value="" name="user_id" type="text" class="form-control" id="title" placeholder="회원ID를 입력해주세요" required>
              </div>
               <div class="form-group">
                <label for="user_pw">암호</label>
                <input value="" name="user_pw" type="password" class="form-control" id="title" placeholder="암호를 입력해주세요" required>
              </div>
              <div class="form-group">
            ...
            <div class="card-footer text-right">
              ...
              <button type="button" class="btn btn-info" id="btn_prev">이전페이지</button>
