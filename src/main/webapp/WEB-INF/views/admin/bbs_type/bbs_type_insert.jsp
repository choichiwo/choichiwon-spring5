          ...
          <form name="form_write" method="post" action="/admin/bbs_type/bbs_type_insert" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                ...
                <input value="" name="board_type" type="text" class="form-control" id="board_type" placeholder="게시판타입을 입력해주세요" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input value="0" name="board_sun" type="number" class="form-control" id="board_name" placeholder="출력순서를 입력해주세요" required>
              </div>
